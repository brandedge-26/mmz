        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
          <div className="grid lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-3 space-y-6">
              ...
              {/* Error */}
              {error && (
                <div className="bg-red-50 border border-red-200 text-red-600 text-sm px-4 py-3.5 rounded-xl">
                  {error}
                </div>
              )}
              ...
              {success ? (
                <div className="flex flex-col items-center text-center py-10 px-6 bg-green-50 border border-green-100 rounded-2xl">
                  ...
                  <p className="text-gray-500 text-sm leading-relaxed max-w-xs mb-6">
                    Thanks for reaching out. Our team will get back to you within 24 hours — or call us for a faster response.
                  </p>
                  <div className="flex flex-wrap gap-3 justify-center">
                    ...
                    <a
                      ...
                      className="px-6 py-2.5 rounded-full bg-green-500 hover:bg-green-600 text-white text-sm font-semibold transition-colors flex items-center gap-2"
                    >
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className={`font-semibold px-8 py-3.5 rounded-full transition-colors text-sm shadow-md shadow-violet-200 ${
                    loading
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="flex gap-2 mt-3">
                        <a href="tel:+923152413134" className="inline-flex items-center gap-1.5 bg-violet-600 hover:bg-violet-700 text-white text-xs font-semibold px-4 py-2 rounded-full transition-colors">
                          <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                          </svg>
                          Call Now
                        </a>
                        <a href="https://api.whatsapp.com/send/?phone=923152413134&text&type=phone_number&app_absent=0" target="_blank" rel="noopener noreferrer"
          ...
          <div className="mt-14 pt-10 border-t border-gray-100">
            ...
            <div className="grid sm:grid-cols-2 gap-5">
              ...
              <div className="border border-gray-100 rounded-2xl overflow-hidden">
                <iframe src="https://www.google.com/maps?q=City+Star+Mall+Saddar+Karachi&output=embed" width="100%" height="200" style={{ border: 0 }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Branch 1 - Saddar" />
              ...
              <div className="border border-gray-100 rounded-2xl overflow-hidden">
                <iframe src="https://www.google.com/maps?q=Geo+Mobile+Market+North+Karachi&output=embed" width="100%" height="200" style={{ border: 0 }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Branch 2 - North Karachi" />
                <div className="p-4 space-y-1">
                  <div className="flex items-center gap-2">
                    <span className="w-2 h-2 rounded-full bg-violet-500 flex-shrink-0" />
