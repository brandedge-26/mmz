            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-gray-50 border border-gray-100 flex items-center justify-center overflow-hidden">
                    <Image src="/header-images/phone-repair/iphone.png" alt="iPhone" width={28} height={28} className="object-contain" />
                  </div>
                  <span className="text-violet-600 text-sm font-semibold uppercase tracking-widest">iPhone Repair</span>
                </div>

                <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-900 leading-tight tracking-tight">
                  Expert iPhone repairs — done right.
                </h1>

                <p className="text-gray-400 text-lg leading-relaxed max-w-lg">
                  Cracked screen, dead battery, or water damage — we fix all iPhone models with genuine-grade parts and back every repair with a warranty.
                </p>
              ...
              <div className="relative flex justify-center lg:justify-end">
                <div className="relative w-full max-w-md aspect-[4/3] rounded-3xl overflow-hidden bg-gray-50 border border-gray-100">
                  <Image src="/home/phone-repair/iphone.png" alt="iPhone Repair" fill className="object-contain p-6" />
                  <div className="absolute bottom-4 left-4 right-4 bg-white/90 backdrop-blur-sm rounded-2xl px-4 py-3 flex items-center gap-3 border border-gray-100">
                    <Image src="/repairs/apple-badge.png" alt="Apple" width={36} height={36} className="object-contain" />
                    <div>
                      <p className="text-xs font-bold text-gray-900">Authorised Repair Provider</p>
                      <p className="text-xs text-gray-400">Genuine-grade Apple parts used</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="py-16 border-b border-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="mb-10">
              ...
              <h2 className="text-3xl font-extrabold text-gray-900 tracking-tight">Common iPhone repairs</h2>
            </div>
        ...
        <section className="py-16 border-b border-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="mb-8">
              ...
              <h2 className="text-3xl font-extrabold text-gray-900 tracking-tight">All iPhone models covered</h2>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-3xl px-8 py-14 text-center relative overflow-hidden">
              ...
              <div className="relative z-10 max-w-xl mx-auto space-y-5">
                <span className="inline-flex items-center gap-2 bg-violet-50 border border-violet-200 text-violet-600 text-sm font-medium px-4 py-1.5 rounded-full">
                  ...
                  Same Day iPhone Repair Available
                </span>
                <h2 className="text-3xl font-extrabold text-gray-900 tracking-tight">Ready to fix your iPhone?</h2>
