...
const socials = [
  {
    label: "Facebook",
    href: "https://www.facebook.com/share/1Cx6yuBRaZ/",
    icon: (
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/mmzmobilecare?igsh=MW9jODRhazg5ams3Ng==",
    icon: (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "TikTok",
    href: "https://www.tiktok.com/@mmzmobilecare?_r=1&_t=ZS-986i4Kt65Lc",
    icon: (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
    ...
    <footer className="bg-gray-100 border-t border-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <p className="text-gray-500 text-sm leading-relaxed max-w-xs">
              Karachi&apos;s trusted mobile repair shop. Fast, reliable repairs for all major devices — backed by a lifetime warranty.
            </p>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-xs text-gray-400 leading-none mb-0.5">Branch 2 — North Karachi</p>
                  <p className="text-sm text-gray-700 leading-snug">Shop No 122, 1st Floor, Geo Mobile<br />Market, North Karachi</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-2 pt-1">
              {socials.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  className="w-9 h-9 rounded-xl bg-gray-200 hover:bg-violet-600 flex items-center justify-center text-gray-500 hover:text-white transition-all"
                >
                  {s.icon}
                </a>
              ))}
          ...
          {/* Company column */}
          <div>
            <h3 className="text-gray-900 font-bold text-sm mb-5">Company</h3>
            <ul className="space-y-3">
          ...
          {/* Get in touch column */}
          <div>
            <h3 className="text-gray-900 font-bold text-sm mb-5">Get In Touch</h3>
            <div className="space-y-3">
              <a
      ...
      <div className="border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <p className="text-gray-400 text-xs">
            Developed by{" "}
            <a href="https://brandedgecreations.io" target="_blank" rel="noopener noreferrer" className="text-violet-500 hover:text-violet-700 font-medium transition-colors">
              BrandEdge Creations
            </a>
          </p>
          <div className="flex gap-5">
            {["Privacy Policy", "Terms of Service"].map((item) => (
              <Link key={item} href="#" className="text-gray-400 hover:text-gray-600 text-xs transition-colors">
                {item}
              </Link>
            ))}
          </div>
